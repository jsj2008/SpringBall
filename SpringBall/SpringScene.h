...
enum EditorObjects { EO_EASYWIND/*must be 1st*/, /*EO_STRONGWIND,*/ EO_START, EO_FINISH, EO_TRANSIT, EO_ARROW, EO_HYPER, EO_SPIKE, EO_REPEL0, EO_REPEL1, EO_REPEL2, EO_NOGRAV, EO_PLATFORM, EO_PLATFORM1, EO_SAW, EO_TELEPORT, EO_SCREW, EO_STAR, EO_MAX/*must be always at the end*/ };
